...
final class PhpTypeGeneratorTest extends TestCase
{
    private static function makeGenerator(SchemaRegistry $registry = new SchemaRegistry([])): PhpTypeGenerator
    {
        return new PhpTypeGenerator(
